...
class Tooth(pygame.sprite.Sprite):
    ...
    def update(self,dt ):
        ...
        #to flip the ememy if the moves to left
...
class Shell(pygame.sprite.Sprite):
    def __init__(self, pos, frames, groups, reverse, player, create_pearl):
        ...
        if reverse:
            ...
            for key, surfs in frames.items():
                # key -> names of animation , surfs -> animation
    ...
    # to fire bullets when player is near
    def state_management(self):
        ...
        if player_near and player_front and player_front and player_level and not self.shoot_timer.active :
    #       player is near
            self.state = 'fire'
            self.frame_index = 0
