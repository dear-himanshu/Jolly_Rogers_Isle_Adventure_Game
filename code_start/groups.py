...
# Sprite is used to create all sprites

# Class for overworld maintain
...
class AllSprites(pygame.sprite.Group):
    def __init__(self, width, height, clouds, horizon_line,  bg_tile = None, top_limit = 0 ):
        ...
        if bg_tile:
            ...
            # small clouds
            # timer that creates a small cloud evey 2.5 second
    ...
    def draw_sky(self):
        ...
        horizon_pos = self.horizon_line + self.offset.y  #seperate the sky with water , so that bg don't appear in water
    ...
    def draw(self, target_pos, dt ):
        ...
        # create clouds if not any bg tile
        if self.sky:
        ...
        #returns all sprite in the group
        for sprite in sorted(self, key= lambda sprite : sprite.z):   # to maintain order of display of sprites #the element
                                                                    # with higher z will displayed last
